...
const fernProgress =
    document.querySelector('.fern-progress');

const fernValue =
    document.querySelector('.fern-progress-value');

if (fernProgress) {

    fernProgress.style.setProperty(
        '--progress',
        `${progressPercent}%`
    );
